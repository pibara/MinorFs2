...
CapFsGuard::CapFsGuard(std::string acpath,std::string secretsalt):mMinorFsGid(getgrnamgid()),mAppArmorConfined(acpath),mNoAccess(mOpenFileCollection),mAccess(secretsalt,mOpenFileCollection){}
